          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <ScrollReveal key={project.title} delay={i * 0.15}>
                <Link
                  href="/case-studies"
                  className="group block bg-white border border-slate-200 rounded-xl overflow-hidden hover:shadow-lg transition-all"
                >
                  ...
                  <div className="p-5">
                    ...
                    <h3 className="text-base font-bold text-slate-900 mb-1 group-hover:text-accent transition-colors">
                      {project.title}
                    </h3>
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {[
                ...
                <Link
                  key={area}
                  href="/areas-covered"
                  className="px-4 py-2 bg-slate-100 hover:bg-accent-light text-slate-700 hover:text-accent-700 rounded-full text-sm font-medium transition-colors"
                >
                  {area}
                </Link>
              ))}
