            ...
            <div className="lg:col-span-1 space-y-6">
              <ScrollReveal>
                <div className="bg-white border border-slate-200 rounded-xl p-6">
                  ...
                  <h3 className="text-base font-bold text-slate-900 mb-1">Phone</h3>
                  <a
                    href={business.phoneHref}
                    className="text-slate-700 hover:text-accent text-sm"
                  >
                    {business.phone}
                  </a>
                </div>
              ...
              <ScrollReveal delay={0.1}>
                <div className="bg-white border border-slate-200 rounded-xl p-6">
                  ...
                  <h3 className="text-base font-bold text-slate-900 mb-1">Mobile &amp; WhatsApp</h3>
                  <a
                    href={business.mobileHref}
                    className="text-slate-700 hover:text-accent text-sm block"
                  >
                    {business.mobile}
                  </a>
                  <a
              ...
              <ScrollReveal delay={0.2}>
                <div className="bg-white border border-slate-200 rounded-xl p-6">
                  ...
                  <h3 className="text-base font-bold text-slate-900 mb-1">Address</h3>
              ...
              <ScrollReveal delay={0.3}>
                <div className="bg-white border border-slate-200 rounded-xl p-6">
                  ...
                  <h3 className="text-base font-bold text-slate-900 mb-2">Opening Hours</h3>
              ...
              <ScrollReveal delay={0.4}>
                <div className="bg-accent-light border border-accent/20 rounded-xl p-6">
                  <h3 className="text-base font-bold text-slate-900 mb-2">Service Area</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal>
            <div className="text-center mb-8">
              ...
              <p className="text-slate-600 mt-2">{business.address}</p>
            </div>
          </ScrollReveal>
          <ScrollReveal>
            <div className="bg-white border border-slate-200 rounded-xl overflow-hidden aspect-video flex items-center justify-center">
