  ...
  return (
    <ScrollReveal delay={index * 0.1}>
      <div className="bg-white border border-slate-200 rounded-xl p-6 h-full flex flex-col">
        ...
        <h3 className="text-lg font-bold text-slate-900 mb-2">{brochure.title}</h3>
        <p className="text-sm text-slate-600 leading-relaxed mb-6 flex-1">{brochure.description}</p>
        <a
          href={brochure.href}
