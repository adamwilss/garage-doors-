...
export function Footer() {
  return (
    <footer className="bg-accent dark:bg-accent-700 text-white/80 transition-colors">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <ul className="text-sm space-y-2">
              <li>
                ...
                <a href={business.phoneHref} className="text-white hover:text-urgent transition-colors">
                  {business.phone}
                </a>
              </li>
              <li>
                <span className="text-white/60">Mobile:</span>{" "}
                <a href={business.mobileHref} className="text-white hover:text-urgent transition-colors">
                  {business.mobile}
                </a>
              </li>
              <li>
                <span className="text-white/60">Address:</span> {business.address}
              </li>
              <li>
                <span className="text-white/60">VAT:</span> {business.vat}
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/areas-covered" className="text-urgent hover:text-urgent-light transition-colors">
                  View all areas
                </Link>
              </li>
            </ul>
