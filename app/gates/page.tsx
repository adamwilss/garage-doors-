            ...
            {gateTypes.map((gate, i) => (
              <ScrollReveal key={gate.name} delay={i * 0.1}>
                <div className="bg-white dark:bg-[#1a1a1a] border border-slate-200 dark:border-[#2a2a2a] rounded-xl p-6 h-full">
                  ...
                  <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-2">{gate.name}</h3>
            ...
            <ScrollReveal direction="right">
              <div className="space-y-4">
                {[
                  ...
                  <div
                    key={item.title}
                    className="bg-white dark:bg-[#1a1a1a] border border-slate-200 dark:border-[#2a2a2a] rounded-xl p-5">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal>
            <div className="text-center max-w-3xl mx-auto mb-10">
              <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-white mb-4 whitespace-nowrap">
          ...
          <ScrollReveal>
            <div className="flex flex-wrap justify-center gap-3">
              {[
                ...
                <span
                  key={area}
                  className="px-4 py-2 bg-slate-100 dark:bg-[#1a1a1a] text-slate-700 dark:text-slate-300 rounded-full text-sm font-medium border border-slate-200 dark:border-[#2a2a2a]"
                >
                  {area}
                </span>
              ))}
