            ...
            {repairIssues.map((issue, i) => (
              <ScrollReveal key={issue} delay={i * 0.08}>
                <div className="bg-white border border-slate-200 rounded-xl p-6 flex items-start gap-4">
                  <div className="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-accent-light text-accent shrink-0">
            ...
            <ScrollReveal direction="right">
              <div className="bg-white border border-slate-200 rounded-xl p-6 space-y-5">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-slate-900">All makes repaired</h3>
                    <p className="text-sm text-slate-600">We do not only repair doors we installed. Any manufacturer, any age.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-accent-light text-accent shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600">Based in Carlisle with local knowledge and spare parts for common faults.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-accent-light text-accent shrink-0">
                  ...
                  <div>
                    <h3 className="font-bold text-slate-900">Safety checked</h3>
                    <p className="text-sm text-slate-600">Every repair includes a safety inspection to ensure your door meets current standards.</p>
                  </div>
                </div>
              </div>
            </ScrollReveal>
