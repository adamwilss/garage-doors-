            ...
            {garageDoorTypes.map((type, i) => (
              <ScrollReveal key={type.name} delay={i * 0.1}>
                <div className="bg-white border border-slate-200 rounded-xl p-6 lg:p-8">
                  ...
                  <p className="text-slate-600 leading-relaxed mb-4">{type.description}</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-8">
            <ScrollReveal delay={0.1}>
              <div>
                <h3 className="text-lg font-bold text-slate-900 mb-3">Panel Styles</h3>
                <ul className="space-y-2">
            ...
            <ScrollReveal delay={0.2}>
              <div>
                <h3 className="text-lg font-bold text-slate-900 mb-3">Finishes &amp; Colours</h3>
                <ul className="space-y-2">
            ...
            <ScrollReveal delay={0.3}>
              <div>
                <h3 className="text-lg font-bold text-slate-900 mb-3">Options &amp; Accessories</h3>
                <ul className="space-y-2">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <ScrollReveal delay={0.1}>
              <div className="bg-white border border-slate-200 rounded-xl p-6">
                <h3 className="text-lg font-bold text-slate-900 mb-2">Alutech Levigato</h3>
                <p className="text-slate-600 leading-relaxed">{alutechContent.levigato}</p>
              </div>
            </ScrollReveal>
            <ScrollReveal delay={0.2}>
              <div className="bg-white border border-slate-200 rounded-xl p-6">
                <h3 className="text-lg font-bold text-slate-900 mb-2">Alutech Avanti</h3>
                <p className="text-slate-600 leading-relaxed">{alutechContent.avanti}</p>
              </div>
            </ScrollReveal>
          </div>
        </div>
